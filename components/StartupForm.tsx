  ...
  const handleFormSubmit = async (prevState: any, formData: FormData) => {
    try {
      ...
      await formSchema.parseAsync(formValues);
       ...
       const result = await createPitch(prevState, formData, idea);


     if (result.status == "SUCCESS") {
       toast({
         title: "Success",
         description: "Your Ideal has been created successfully",
       });
  ...
  return (
    <form action={formAction} className='startup-form'>
      ...
      <div>
        ...
        <Input id='category' name='category' className='startup-form_input' required placeholder='Idea category (Tech, Health, Education....)'/>
      ...
      <div data-color-mode='light'>
        <label htmlFor='idea' className='startup-form_label'>
          Idea
        </label>
        <MDEditor 
          value={idea} 
          ...
          textareaProps={{
            placeholder: 'Describe your idea and what problem can be solves.'
          }}
          previewOptions={{
       ...
       <Button type="submit" className="startup-form_btn" disabled={isPending}>
          {isPending ? "Submitting.." : "Submit your Ideals"}
